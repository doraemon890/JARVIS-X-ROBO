...
# from JarvisRobo.modules.sql import warns_sql as warnssql
import JarvisRobo.modules.sql.blacklist_sql as blacklistsql

# from JarvisRobo.modules.sql import cust_filters_sql as filtersql
# import JarvisRobo.modules.sql.welcome_sql as welcsql
import JarvisRobo.modules.sql.locks_sql as locksql
import JarvisRobo.modules.sql.notes_sql as sql

# from JarvisRobo.modules.rules import get_rules
import JarvisRobo.modules.sql.rules_sql as rulessql
from JarvisRobo import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from JarvisRobo.__main__ import DATA_IMPORT
from JarvisRobo.modules.connection import connected
from JarvisRobo.modules.helper_funcs.alternate import typing_action
from JarvisRobo.modules.helper_funcs.chat_status import user_admin
from JarvisRobo.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("JarvisRobo{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("JarvisRobo{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `JarvisRobo-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("JarvisRobo{}.backup".format(chat_id))  # Cleaning file

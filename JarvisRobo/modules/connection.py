...
import JarvisRobo.modules.sql.connection_sql as sql
from JarvisRobo import DEV_USERS, DRAGONS, dispatcher
from JarvisRobo.modules.helper_funcs import chat_status

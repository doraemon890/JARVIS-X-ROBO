...
from JarvisRobo.modules.alive import Jarvis
import JarvisRobo.modules.sql.userinfo_sql as sql
...
from JarvisRobo.__main__ import STATS, TOKEN, USER_INFO
from JarvisRobo.modules.disable import DisableAbleCommandHandler
from JarvisRobo.modules.helper_funcs.chat_status import sudo_plus
from JarvisRobo.modules.helper_funcs.extraction import extract_user
from JarvisRobo.modules.sql.global_bans_sql import is_user_gbanned
from JarvisRobo.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/JARVIS_X_SUPPORT">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url=f"https://t.me/JARVIS_X_SUPPORT"
                            ),
                            InlineKeyboardButton(
                                "Dɪsᴀsᴛᴇʀ", url="https://t.me/JARVIS_X_SUPPORT"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/JARVIS_X_SUPPORT"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/JARVIS_X_SUPPORT"
                            ),
                        ],
                        [
                            InlineKeyboardButton(

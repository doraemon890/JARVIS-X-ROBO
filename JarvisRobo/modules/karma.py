...
from JarvisRobo import OWNER_ID, pbot
from JarvisRobo.utils.admins import can_change_info
from JarvisRobo.utils.errors import capture_err
from JarvisRobo.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|thank you|gud|thankyou|love|pro)$"
